...
class ContextAnalyzer:
    ...
    def get_contexts(response_text, search_string):
        ...
        xpath = (
            ...
            + "')] or @onclick[contains(.,'"
            + search_string
            + "')] or @oncontextmenu[contains(.,'"
            + search_string
            + "')] or @ondblclick[contains(.,'"
            + search_string
            + "')] or @onmousedown[contains(.,'"
            + search_string
            + "')] or @onmouseenter[contains(.,'"
            + search_string
            + "')] or @onmouseleave[contains(.,'"
            + search_string
            + "')] or @onmousemove[contains(.,'"
            + search_string
            + "')] or @onmouseover[contains(.,'"
            + search_string
            + "')] or @onmouseout[contains(.,'"
            + search_string
            + "')] or @onmouseup[contains(.,'"
            + search_string
            + "')] or @onkeydown[contains(.,'"
            + search_string
            + "')] or @onkeypress[contains(.,'"
            + search_string
            + "')] or @onkeyup[contains(.,'"
            + search_string
            + "')] or @onabort[contains(.,'"
            + search_string
            + "')] or @onbeforeunload[contains(.,'"
            + search_string
            + "')] or @onhashchange[contains(.,'"
            + search_string
            + "')] or @onpageshow[contains(.,'"
            + search_string
            + "')] or @onpagehide[contains(.,'"
            + search_string
            + "')] or @onresize[contains(.,'"
            + search_string
            + "')] or @onscroll[contains(.,'"
            + search_string
            + "')] or @onunload[contains(.,'"
            + search_string
            + "')] or @onblur[contains(.,'"
            + search_string
            + "')] or @onchange[contains(.,'"
            + search_string
            + "')] or @onfocus[contains(.,'"
            + search_string
            + "')] or @onfocusin[contains(.,'"
            + search_string
            + "')] or @onfocusout[contains(.,'"
            + search_string
            + "')] or @oninput[contains(.,'"
            + search_string
            + "')] or @oninvalid[contains(.,'"
            + search_string
            + "')] or @onreset[contains(.,'"
            + search_string
            + "')] or @onsearch[contains(.,'"
            + search_string
            + "')] or @onselect[contains(.,'"
            + search_string
            + "')] or @ondrag[contains(.,'"
            + search_string
            + "')] or @ondragend[contains(.,'"
            + search_string
            + "')] or @ondragenter[contains(.,'"
            + search_string
            + "')] or @ondragleave[contains(.,'"
            + search_string
            + "')] or @ondragover[contains(.,'"
            + search_string
            + "')] or @ondragstart[contains(.,'"
            + search_string
            + "')] or @ondrop[contains(.,'"
            + search_string
            + "')] or @oncopy[contains(.,'"
            ...
            + "')] or @onpaste[contains(.,'"
            + search_string
            + "')] or @onafterprint[contains(.,'"
            + search_string
            + "')] or @onbeforeprint[contains(.,'"
            + search_string
            + "')] or @onabort[contains(.,'"
            + search_string
            + "')] or @oncanplay[contains(.,'"
            + search_string
            + "')] or @oncanplaythrough[contains(.,'"
            + search_string
            + "')] or @ondurationchange[contains(.,'"
            + search_string
            + "')] or @onemptied[contains(.,'"
            + search_string
            + "')] or @onended[contains(.,'"
            + search_string
            + "')] or @onloadeddata[contains(.,'"
            + search_string
            + "')] or @onloadedmetadata[contains(.,'"
            + search_string
            + "')] or @onloadstart[contains(.,'"
            + search_string
            + "')] or @onpause[contains(.,'"
            + search_string
            + "')] or @onplay[contains(.,'"
            + search_string
            + "')] or @onplaying[contains(.,'"
            + search_string
            + "')] or @onprogress[contains(.,'"
            + search_string
            + "')] or @onratechange[contains(.,'"
            + search_string
            + "')] or @onseeked[contains(.,'"
            + search_string
            + "')] or @onseeking[contains(.,'"
            + search_string
            + "')] or @onstalled[contains(.,'"
            + search_string
            + "')] or @onsuspend[contains(.,'"
            + search_string
            + "')] or @ontimeupdate[contains(.,'"
            + search_string
            + "')] or @onvolumechange[contains(.,'"
            + search_string
            + "')] or @onwaiting[contains(.,'"
            + search_string
            + "')] or @onopen[contains(.,'"
            + search_string
            + "')] or @onmessage[contains(.,'"
            + search_string
            + "')] or @onmousewheel[contains(.,'"
            + search_string
            + "')] or @ononline[contains(.,'"
            + search_string
            + "')] or @onoffline[contains(.,'"
            + search_string
            + "')] or @onpopstate[contains(.,'"
            + search_string
            + "')] or @onshow[contains(.,'"
            + search_string
            + "')] or @onstorage[contains(.,'"
            + search_string
            + "')] or @ontoggle[contains(.,'"
            + search_string
            + "')] or @onwheel[contains(.,'"
            + search_string
            + "')] or @ontouchcancel[contains(.,'"
            + search_string
            + "')] or @ontouchend[contains(.,'"
            + search_string
            + "')] or @ontouchmove[contains(.,'"
            + search_string
            + "')] or @ontouchstart[contains(.,'"
            + search_string
            + "')] or @onsubmit[contains(.,'"
            + search_string
            + "')]]"
        )
